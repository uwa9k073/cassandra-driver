...
TEST(Lz4Compressor, Compress) {
    ...
    cassandra::io::BufferReader<cassandra::io::protocol::BufferView> reader(output_buffer);
...
TEST(Lz4Compressor, Decompress) {
    ...
    cassandra::io::BufferReader<cassandra::io::protocol::BufferView> reader(decompressed);
